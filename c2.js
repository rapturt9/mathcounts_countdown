...
What is the value of open parentheses 7 plus 4 over 9 closed parentheses over open parentheses 9 plus 4 over 8 closed parentheses? Express your answer as a common fraction.
...
If the square root of 8 plus the square root of 18 equals the square root of x, what is the value of x?

If 2 A 2 comma 7 B 5 is divisible by 99, for digits A and B, what is the value of 10A + B?
...
How many ordered triples of positive integers (x comma y comma z) satisfy xyz = 12?
...
If x is a number such that x squared + x − 1 = 0, what is the value of 4x squared + 4x + 1?
...
What is the value of 8100 − open parentheses 94 times 86 closed parentheses?

Trajan randomly selects three distinct numbers from the set {1 comma 2 comma 3 comma 4 comma 5}. What is the probability that the sum of the selected numbers is divisible by 3? Express your answer as a common fraction.

What is the remainder when 50 factorial is divided by 51?
...
What is the sum of the solutions of the equation 4x squared = 12x + 7?
...
Two opposite vertices of a square have coordinates (3 comma 5) and (−11 comma 7). What is the area of this square, in square units? 
...
If 3 to the k times 9 squared times 27 = 3 to the power of 13, what is the value of k ?
...
What is the value of 111 squared – 11 squared + 1 squared?
...
What is the quotient when 1,000,000,000 is divided by 2 to the eight times 5⁷?

If f of (x comma y) = y + x + y, what is the value of f of (116 comma 25)?

What is the value of open parentheses 10 to the seventh minus 10 to the sixth closed parentheses over eighteen?
...
For how many ordered pairs of integers (x comma y) is the point (x comma y) exactly 5 units away from the point (20 comma 15)?

If the lines defined by the equations 3x + 2 why = 9 and bx − y = 119 are parallel to each other, what is the value of b? Express your answer as a common fraction.

A certain rectangular prism has two faces, each of area 42 square meters, two faces, each of area 54 meters squared and two faces, each of area 63 meters squared. What is the sum of the 12 edge lengths of the prism, in meters?

If 5 to the power of open parentheses x squared minus 8 closed parentheses plus 9 = 10, what is the value of x?

What is the value of 36 + 64 ? Express your answer as a common fraction.

Jenny ran 1 mile up a hill in 15 minutes. If it took her 9 minutes to run back down the hill, along the same path, what was Jenny’s average speed, in miles per hour, over the whole run?


Define the binary operation up as a up b = a squared + 2a b + b squared. What is the value of open parentheses 1 up 1 closed parentheses up 9?

What is the value of open parentheses 3 to the power of 2019 plus 3 to the power of 2016 closed parentheses over open parentheses 3 to the power of 2018 minus 3 to the power of 2015? Express your answer as a common fraction.

The numbers {6 comma 5 comma 3 comma 7 comma y} have arithmetic mean y. What is the median of these numbers? Express your answer as a decimal to the nearest hundredth.
...
What is the value of 6 factorial + 3 factorial + 2 factorial + 1 factorial?

Circle A has area 16 units squared and circle B has area 64 units squared. What is the ratio of the radius of circle A to the radius of circle B? Express your answer as a common fraction.
...
What is the remainder when 1 + 3 + 3 squared + 3 cubed + dot dot dot + 3 to the power of 2020 is divided by 81?

Together, the total value of 2n nickels, 5n pennies and n dimes is $1.50. What is the value of n?

The sum of the digits of a particular three-digit number is 16. The tens digit of this number is three times the units digit, and the hundreds digit is one more than the units digit. What is the number?

If a and b are positive integers with a to the power of b equals 64, what is the sum of all possible values of b?

What is the value of 2020 squared minus 2020 times 2019 plus 2019 squared minus 2019 times 2020?`